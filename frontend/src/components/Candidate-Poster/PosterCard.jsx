...
export default function PosterCard({ title, name, description, pdfLink }) {
    return (
        <div className=' ml-20 text-white p-4 w-11/12 rounded-lg shadow-lg bg-[#3B0B2E] '>
            ...
            <div className='flex m-w-full gap-15'>
                <img src={sampleImage} alt={`${name}'s poster`} className='rounded-lg w-32 sm:w-48 md:w-64 lg:w-80 h-auto' />
                <div className='flex flex-col'>
                    ...
                    {pdfLink && (
                        <a
                            ...
                            className='mb-5 ml-auto self-start mt-auto px-4 py-2 bg-white text-[#3B0B2E] font-semibold rounded hover:bg-gray-200 transition'
                        >
                            View Credentials
                        </a>
                    )}
